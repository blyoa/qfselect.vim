...
execute join(['function! vital#_qfselect#App#WindowSelector#import() abort', printf("return map({'select': ''}, \"vital#_qfselect#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
