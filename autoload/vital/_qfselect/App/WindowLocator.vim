...
execute join(['function! vital#_qfselect#App#WindowLocator#import() abort', printf("return map({'focus': '', 'get_conditions': '', 'list': '', 'find': '', 'score': '', 'set_threshold': '', 'set_conditions': '', 'get_threshold': ''}, \"vital#_qfselect#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:threshold = 0
let s:conditions = [
